...
static struct gpio_irq_t keys_irq[]={
	{PB_PIO_IRQ(PAD_GPIO_A+28),mykey_irq_handler,IRQF_TRIGGER_FALLING,"gpio_28_irq",NULL},
	{PB_PIO_IRQ(PAD_GPIO_B+30),mykey_irq_handler,IRQF_TRIGGER_FALLING,"gpio_30_irq",NULL},
	{PB_PIO_IRQ(PAD_GPIO_B+31),mykey_irq_handler,IRQF_TRIGGER_FALLING,"gpio_31_irq",NULL},
	{PB_PIO_IRQ(PAD_GPIO_B+9),mykey_irq_handler,IRQF_TRIGGER_FALLING,"gpio_9_irq",NULL},	
};
